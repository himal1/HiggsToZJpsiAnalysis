...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:YourRootFile_step1.root'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:YourRootFile_step2.root'),
