...
process.source = cms.Source("PoolSource",
   ...
   #   'root://cmsxrootd.fnal.gov//store/user/jheidema/88DB60AC-6B3B-E611-A500-02163E011FE3.root' ##original data from grant
...
#'file:/afs/cern.ch/user/h/hacharya/1Scratch/UsingProgramForRun279841forJPhiPeak/CMSSW_9_2_3_patch2/src/1EB28D2D-5F64-E611-86B6-FA163EB2E381.root'#2016 data
#'root://cms-xrd-global.cern.ch//store/data/Run2016D/Charmonium/AOD/07Aug17-v1/10000/08A9E4E6-D3A2-E711-B7DA-0025905A48D8.root'#Charmonium/Run2016D-07Aug17-v1/AOD
'/store/data/Run2017D/Charmonium/AOD/17Nov2017-v1/00000/0068310F-14FF-E711-A606-A4BF0112BC78.root'#charmonium 2017 AOD Nov 17
#'/store/data/Run2017B/Charmonium/AOD/17Nov2017-v1/70000/08A3BC03-05EC-E711-8CE8-0242AC130002.root' #Data set that ends in 57
...
#process.GlobalTag.globaltag = cms.string('80X_dataRun2_2016SeptRepro_v6')#2016GLOBAL TAG
process.GlobalTag.globaltag = cms.string('94X_dataRun2_ReReco_EOY17_v2')#2017globaltag
...
process.PATEventTree = cms.EDAnalyzer("PATEventTree",
    rootFileName                 = cms.untracked.string("StefanHimalForCompleteOneRootFile_D_2017WithJPsiPtGreaterThan2.root"),
